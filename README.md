...
| STM32F746IGT6 (Cortex-M7, 1 MB / 320 KB) | `STM32F746IG` LQFP176 | — |
...
| DC/AC/pulse sources, battery, ground, labelled supply rail | done; every source has an internal resistance and a current rating; the rail's supply trips (goes dead) past its `Max current` |
...
| Oscilloscope on probes, pin/wire readouts, current flow animation | done |
